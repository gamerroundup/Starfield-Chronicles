...
export async function generateCharacterDossier(playstyle, name, background, traits, urlOverride = null, keyOverride = null, geminiKeyOverride = null) {
  ...
  const prompt = `
    ...
    If Name is empty or 'Unknown Explorer', you MUST generate a unique, immersive Starfield character name.
    If Background or Traits are empty or default, you MUST choose from the official lists below to make a unique, cohesive character. Do NOT just copy 'Alien DNA' or 'Explorer' every time; rotate and select a variety of cool backgrounds and traits matching the selected playstyle.
